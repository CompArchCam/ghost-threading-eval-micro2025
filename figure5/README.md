Figure 5 of the paper compares the performance of Ghost Threading with different approaches 
...
2. Based on the profiling results, edit the `selected_workloads` list in `path_to_the_artifact/figure5/compute_speedup.py`:
```python
